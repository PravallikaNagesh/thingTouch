...
reg32 * CapSense_pcTable[] = {
    ...
    (reg32 *)CapSense_Sns__RadialSlider1_e0__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider1_e1__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider1_e2__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider1_e3__RS__PC, 
    (reg32 *)CapSense_Sns__RadialSlider1_e4__RS__PC, 
};
...
const uint8 CapSense_portTable[] = {
    ...
    CapSense_Sns__RadialSlider1_e0__RS__PORT, 
    CapSense_Sns__RadialSlider1_e1__RS__PORT, 
    CapSense_Sns__RadialSlider1_e2__RS__PORT, 
    CapSense_Sns__RadialSlider1_e3__RS__PORT, 
    CapSense_Sns__RadialSlider1_e4__RS__PORT, 
};
...
const uint32 CapSense_maskTable[] = {
    ...
    CapSense_Sns__RadialSlider1_e0__RS__MASK, 
    CapSense_Sns__RadialSlider1_e1__RS__MASK, 
    CapSense_Sns__RadialSlider1_e2__RS__MASK, 
    CapSense_Sns__RadialSlider1_e3__RS__MASK, 
    CapSense_Sns__RadialSlider1_e4__RS__MASK, 
};
...
const uint8 CapSense_pinShiftTbl[] = {
    ...
    (uint8) CapSense_Sns__RadialSlider1_e0__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider1_e1__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider1_e2__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider1_e3__RS__SHIFT, 
    (uint8) CapSense_Sns__RadialSlider1_e4__RS__SHIFT, 
};
...
const uint8 CapSense_widgetNumber[CapSense_TOTAL_SENSOR_COUNT] = {
    ...
    6u, /* Button4__BTN */
    7u, /* Button5__BTN */
    0u, 0u, 0u, 0u, 0u, /* RadialSlider0__RS */
    1u, 1u, 1u, 1u, 1u, /* RadialSlider1__RS */
};
