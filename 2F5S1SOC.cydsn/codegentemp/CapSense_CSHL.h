...
#define CapSense_RADIALSLIDER0__RS        (0u)
#define CapSense_RADIALSLIDER1__RS        (1u)
#define CapSense_BUTTON0__BTN        (2u)
#define CapSense_BUTTON1__BTN        (3u)
#define CapSense_BUTTON2__BTN        (4u)
#define CapSense_BUTTON3__BTN        (5u)
#define CapSense_BUTTON4__BTN        (6u)
#define CapSense_BUTTON5__BTN        (7u)

#define CapSense_TOTAL_DIPLEXED_SLIDERS_COUNT        (0u)
#define CapSense_TOTAL_LINEAR_SLIDERS_COUNT          (0u)
#define CapSense_TOTAL_RADIAL_SLIDERS_COUNT          (2u)
...
#define CapSense_TOTAL_BUTTONS_COUNT                 (6u)
...
#define CapSense_RADIAL_SLIDERS_POS_FILTERS_MASK     (0x8u)
#define CapSense_TOUCH_PADS_POS_FILTERS_MASK         (0x0u)
#define CapSense_TRACKPAD_GEST_POS_FILTERS_MASK      (0x0u)

#define CapSense_UNUSED_DEBOUNCE_COUNTER_INDEX       (6u)

#define CapSense_TOTAL_PROX_SENSORS_COUNT            (0u)

#define CapSense_END_OF_SLIDERS_INDEX                (1u)
#define CapSense_END_OF_TOUCH_PAD_INDEX              (1u)
