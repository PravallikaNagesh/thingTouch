...
const uint8 CapSense_portTable[] = {
    ...
    0u | 0x80u, /* ProximitySensor0__PROX */
};

const uint8 CYCODE CapSense_indexTable[CapSense_INDEX_TABLE_SIZE] = {
    0u, 1u, 2u, 3u, 4u,  /*ProximitySensor0__PROX*/
};
