...
#define CapSense_INDEX_TABLE_SIZE              (5u)
...
#define CapSense_SENSOR_PROXIMITYSENSOR0__PROX    (7u)
...
#define CapSense_IS_COMPLEX_SCANSLOTS       (1u)
#define CapSense_COMPLEX_SCANSLOTS_NUM      (1u)
...
#define CapSense_RESOLUTIONS_TBL_SIZE       (4u)
