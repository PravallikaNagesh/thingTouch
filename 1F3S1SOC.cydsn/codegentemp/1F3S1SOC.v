...
module CapSense_CSD_P4_v2_40_4 ;
...
module top ;
    ...
    SCB_P4_v3_10_1 I2C_Slave (
        .interrupt(Net_424),
        .clock(1'b0),
        .rx_tr_out(Net_426),
        .tx_tr_out(Net_427));

    CapSense_CSD_P4_v2_40_4 CapSense ();
	...
	wire [0:0] tmpOE__zeroCrossing_intr_net;
	wire [0:0] tmpFB_0__zeroCrossing_intr_net;
	wire [0:0] tmpIO_0__zeroCrossing_intr_net;
	electrical [0:0] tmpSIOVREF__zeroCrossing_intr_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		zeroCrossing_intr
		 (.oe(tmpOE__zeroCrossing_intr_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__zeroCrossing_intr_net[0:0]}),
		  .io({tmpIO_0__zeroCrossing_intr_net[0:0]}),
		  .siovref(tmpSIOVREF__zeroCrossing_intr_net),
		  .interrupt({Net_26}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__zeroCrossing_intr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
