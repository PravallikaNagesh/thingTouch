// ======================================================================
// 1F3S1SOC.v generated from TopDesign.cysch
// 02/02/2017 at 12:40
...
module CapSense_CSD_P4_v2_40_2 ;
    ...
    defparam CSD_FFB.sensors_count = 9;
	...
	wire [8:0] tmpOE__Sns_net;
	wire [8:0] tmpFB_8__Sns_net;
	wire [8:0] tmpIO_8__Sns_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("f11cf583-f169-4b4e-8b05-530256f64bff/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
		  .drive_mode(27'b000_000_000_000_000_000_000_000_000),
		  .ibuf_enabled(9'b0_0_0_0_0_0_0_0_0),
		  .init_dr_st(9'b1_1_1_1_1_1_1_1_1),
		  .input_clk_en(0),
		  .input_sync(9'b1_1_1_1_1_1_1_1_1),
		  .input_sync_mode(9'b0_0_0_0_0_0_0_0_0),
		  .intr_mode(18'b00_00_00_00_00_00_00_00_00),
		  .invert_in_clock(0),
		  .invert_in_clock_en(0),
		  .invert_in_reset(0),
		  .invert_out_clock(0),
		  ...
		  .oe_conn(9'b0_0_0_0_0_0_0_0_0),
		  .oe_reset(0),
		  .oe_sync(9'b0_0_0_0_0_0_0_0_0),
		  .output_clk_en(0),
		  .output_clock_mode(9'b0_0_0_0_0_0_0_0_0),
		  .output_conn(9'b0_0_0_0_0_0_0_0_0),
		  .output_mode(9'b0_0_0_0_0_0_0_0_0),
		  .output_reset(0),
		  .output_sync(9'b0_0_0_0_0_0_0_0_0),
		  .pa_in_clock(-1),
		  .pa_in_clock_en(-1),
		  .pa_in_reset(-1),
		  .pa_out_clock(-1),
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("Button0__BTN,Button1__BTN,Button2__BTN,Button3__BTN,RadialSlider0_e0__RS,RadialSlider0_e1__RS,RadialSlider0_e2__RS,RadialSlider0_e3__RS,RadialSlider0_e4__RS"),
		  .pin_mode("AAAAAAAAA"),
		  .por_state(4),
		  .sio_group_cnt(0),
		  .sio_hyst(9'b1_1_1_1_1_1_1_1_1),
		  .sio_ibuf(""),
		  .sio_info(18'b00_00_00_00_00_00_00_00_00),
		  .sio_obuf(""),
		  .sio_refsel(""),
		  .sio_vtrip(""),
		  .sio_hifreq(""),
		  .sio_vohsel(""),
		  .slew_rate(9'b0_0_0_0_0_0_0_0_0),
		  .spanning(1),
		  .use_annotation(9'b0_0_0_0_0_0_0_0_0),
		  .vtrip(18'b10_10_10_10_10_10_10_10_10),
		  .width(9),
		  .ovt_hyst_trim(9'b0_0_0_0_0_0_0_0_0),
		  .ovt_needed(9'b0_0_0_0_0_0_0_0_0),
		  .ovt_slew_control(18'b00_00_00_00_00_00_00_00_00),
		  .input_buffer_sel(18'b00_00_00_00_00_00_00_00_00))
		Sns
		 (.oe(tmpOE__Sns_net),
		  .y({9'b0}),
		  .fb({tmpFB_8__Sns_net[8:0]}),
		  .analog({Net_245[8:0]}),
		  .io({tmpIO_8__Sns_net[8:0]}),
	...
	assign tmpOE__Sns_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{9'b111111111} : {9'b111111111};
