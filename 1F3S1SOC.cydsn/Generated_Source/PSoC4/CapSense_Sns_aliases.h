...
#define CapSense_Sns_RadialSlider0_e0__RS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__4__SHIFT*2u)))
...
#define CapSense_Sns_RadialSlider0_e1__RS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__5__SHIFT*2u)))
...
#define CapSense_Sns_RadialSlider0_e2__RS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__6__SHIFT*2u)))
...
#define CapSense_Sns_RadialSlider0_e3__RS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__7__SHIFT*2u)))
...
#define CapSense_Sns_RadialSlider0_e4__RS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__8__SHIFT*2u)))
