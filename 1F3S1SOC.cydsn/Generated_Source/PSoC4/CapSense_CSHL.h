...
#define CapSense_BUTTON2__BTN        (3u)
#define CapSense_BUTTON3__BTN        (4u)

#define CapSense_TOTAL_DIPLEXED_SLIDERS_COUNT        (0u)
#define CapSense_TOTAL_LINEAR_SLIDERS_COUNT          (0u)
#define CapSense_TOTAL_RADIAL_SLIDERS_COUNT          (1u)
...
#define CapSense_END_OF_BUTTONS_INDEX                (4u)
#define CapSense_END_OF_MATRIX_BUTTONS_INDEX         (4u)
#define CapSense_END_OF_WIDGETS_INDEX                (5u)
