...
module CapSense_CSD_P4_v2_40_2 ;
    ...
    defparam CSD_FFB.sensors_count = 8;
	...
	cy_psoc3_pins_v1_10
		#(.id("f11cf583-f169-4b4e-8b05-530256f64bff/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("Button0__BTN,Button1__BTN,Button2__BTN,Button3__BTN,Button4__BTN,Button5__BTN,Button6__BTN,Button7__BTN"),
		  .pin_mode("AAAAAAAA"),
		  .por_state(4),
		  .sio_group_cnt(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0d4b5aef-ace2-4def-b188-c9a08a3d8def"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("18270768-c609-4c82-b77e-8fda45ec8260"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
